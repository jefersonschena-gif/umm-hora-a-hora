...
# (a) nova especialidade na 17ª posição -> vira a 17ª coluna de X na aba Equipe
r = ESP_R1 + 16
cfg.cell(row=r, column=1, value="TOR"); cfg.cell(row=r, column=2, value="Cirurgia Torácica")
...
r = POS_R1 + 11
for c, v in enumerate(["SO-09", "Sala 9 — Torácica", "Sala cirúrgica", 2, 2, 12,
                       "Cirurgia Torácica", "Seg a Sex", "Ativo", "Sala nova"], start=1):
